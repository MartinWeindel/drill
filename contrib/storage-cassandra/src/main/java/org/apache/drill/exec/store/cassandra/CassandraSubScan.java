...
public class CassandraSubScan extends AbstractBase implements SubScan {
    ...
    public static class CassandraSubScanSpec {
        ...
        public CassandraSubScanSpec setUser(String user) {
            this.user = user;
            return this;
        }
        ...
        public CassandraSubScanSpec setPassword(String password) {
        ...
        public String toString() {
            return "CassandraSubScanSpec [keyspace=" + keyspace + ", table="
                    + table + ", host=" + hosts +", port=" + port + ", user=" + user + ", startToken=" + startToken
