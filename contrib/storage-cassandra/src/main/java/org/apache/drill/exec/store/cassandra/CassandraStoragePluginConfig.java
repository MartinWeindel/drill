...
public class CassandraStoragePluginConfig extends StoragePluginConfig {
    ...
    public CassandraStoragePluginConfig(@JsonProperty("config") Map<String, Object> config) {
        ...
        this.user = (String)this.config.get(DrillCassandraConstants.CASSANDRA_CONFIG_USER);
        this.password = (String)this.config.get(DrillCassandraConstants.CASSANDRA_CONFIG_PASSWORD);
    }
